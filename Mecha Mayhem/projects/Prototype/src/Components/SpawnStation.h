...
public:
	...
	void Render(glm::mat4 model) {
		...
		if (m_timer == 0) {
			if (m_currWeapon == Gun::WEAPON::FIST)
	...
	void Update(entt::registry* reg, glm::vec3 pos) {
		...
		if (m_timer > 0) {
			...
			if (m_timer <= 0) {
				...
				switch (rand() % 6) {
				case 0:		m_currWeapon = Gun::WEAPON::FIST;		break;
				case 1:		m_currWeapon = Gun::WEAPON::PISTOL;		break;
				case 2:		m_currWeapon = Gun::WEAPON::RIFLE;		break;
				case 3:		m_currWeapon = Gun::WEAPON::CANNON;		break;
				case 4:		m_currWeapon = Gun::WEAPON::MACHINEGUN;	break;
				case 5:		m_currWeapon = Gun::WEAPON::SHOTGUN;		break;
